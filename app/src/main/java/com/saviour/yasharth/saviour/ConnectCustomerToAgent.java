...
//            }
//        } }, new SecureRandom());
        KeyStore trusted = KeyStore.getInstance("SSL");
       ...
       // SSLSocketFactory sf = new SSLSocketFactory(sslContext,SSLSocketFactory.ALLOW_ALL_HOSTNAME_VERIFIER);
        ...
        client.getCredentialsProvider().setCredentials(
                ...
                new UsernamePasswordCredentials("saviour", "a45abe87d164afb4d5e83353467cc795773d74d0 ")
        );
        HttpPost post = new HttpPost("https://twilix.exotel.in/v1/Accounts/saviour/Calls/connect");
         ...
         */
        nameValuePairs.add(new BasicNameValuePair("From", "08033946662"));
        nameValuePairs.add(new BasicNameValuePair("To", "09412300888"));
        nameValuePairs.add(new BasicNameValuePair("CallerId", "08033946662"));
        nameValuePairs.add(new BasicNameValuePair("Url", "http://my.exotel.in/exoml/start/180862"));
